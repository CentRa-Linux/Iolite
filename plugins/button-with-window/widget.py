...
class Widget:
    ...
    def create(self, engine, props, app, parent=None):
        self.component = QQmlComponent(engine, QUrl(
            "plugins/button-with-window/button.qml"))
        ...
        self.obj = self.component.createWithInitialProperties(
            {"parent": parent, "iconname": iconname}).findChild(QQuickWindow, "window")

        print(self.obj.winId())
        display = Display()
        ...
        self.obj.setProperty("availableGeometryX",
                             screen.availableGeometry().x())
        self.obj.setProperty("availableGeometryY",
        ...
        print(screen.availableGeometry().y())
